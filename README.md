...
- **Advanced POST endpoint - Custom prompt OR Chat completions + generation parameters (/ask-llm-prompted)**
    ...
    **Use Cases:**
    Prompted Mode: Different activities can now use different system prompts and different generation parameters to achieve a model that is personalized to that activites needs.  
